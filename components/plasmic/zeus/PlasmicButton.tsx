...
import sty from "./PlasmicButton.module.css"; // plasmic-import: a4XX9qexQiO/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: sacodgrFhyz/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: bCTfql3JcH7/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__uVebS)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__zoJrG)}
                role={"img"}
              />
            ),
